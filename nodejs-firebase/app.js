import pkg, { response } from 'express'
const express = pkg;
...
const API_KEY = 'api_key=d9754441dd4cfa2e7edac814a34b3c96'
...
app.get('/movie-api', async (req, res) => {
    fetch('https://api.themoviedb.org/3/movie/550?api_key=d9754441dd4cfa2e7edac814a34b3c96')
        .then(res => res.json())
        .then(function (data) {
            mData = data
            console.log(data);
